...
手動安裝
 ...
 下載腳本：wget https://raw.githubusercontent.com/meiloi/scripts/main/tgvsdd3-alpine.sh -O tgvsdd3-alpine.sh


 設置權限：chmod +x tgvsdd3-alpine.sh


 運行安裝：./tgvsdd3-alpine.sh install
